...
def run(robot: Robot) -> None:
    ...
    while True:
        ...
        if state == "INIT":
            ...
            print(f"[CFG] waypoints={len(WAYPOINTS)} velocity={VELOCITY_MM_S:.0f} mm/s lookahead={LOOKAHEAD_MM:.0f} mm tolerance={TOLERANCE_MM:.0f} mm advance_radius={ADVANCE_RADIUS_MM:.0f} mm")
            if ENABLE_LIDAR:
                print(
